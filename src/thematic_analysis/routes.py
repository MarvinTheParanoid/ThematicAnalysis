...
from thematic_analysis.strategies.coding_strategy import analyze_themes_with_coding
...
async def analyze_themes(request: ThemeRequest):
    ...
    match request.strategy:
        ...
        case ThemeStrategy.CODING:
            return await analyze_themes_with_coding(request)
        case _:
